<template>
  ...
  <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    ...
    <div class="md:w-1/2 px-8 md:px-16">
      ...
      <form class="flex flex-col gap-4" @submit.prevent="performLogin">
        <input class="p-2 mt-8 rounded-xl border" v-model="email" type="email" placeholder="Email">
        <div class="relative">
          <input class="p-2 rounded-xl border w-full" v-model="password" type="password" placeholder="Password">
