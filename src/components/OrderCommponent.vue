        ...
        <div class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            <div class="flex justify-start item-start space-y-2 flex-col">
                <h1 class="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">Order
                    #{{ getOrder.code }}</h1>
                <p class="text-base dark:text-gray-300 font-medium leading-6 text-gray-600">{{ getOrder.date }}</p>
            </div>
            <div
                class="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                <div class="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    <div
                        class="flex flex-col justify-start items-start dark:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full" v-for="(order) in getOrder.orders[0].products.data">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex justify-between space-x-8 items-start w-full">
                                    <div class="text-base dark:text-white xl:text-lg leading-6">Price ${{ order.price }}</div>
                        ...
                        <div class="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 dark:bg-gray-800 space-y-6">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    <p class="text-base dark:text-gray-300 leading-4 text-gray-600">${{ getOrder.orders[0].subtotal }}</p>
                                </div>
                                ...
                                <div class="flex justify-between items-center w-full">
                                    <p class="text-base dark:text-white leading-4 text-gray-800">Payment</p>
                                    <p class="text-base dark:text-gray-300 leading-4 text-gray-600">{{ getOrder.orders[0].payment_type }}</p>
                                </div>
                            </div>
                            <div class="flex justify-between items-center w-full">
                                <p class="text-base dark:text-white font-semibold leading-4 text-gray-800">Total</p>
                                <p class="text-base dark:text-gray-300 font-semibold leading-4 text-gray-600">${{(getOrder.grand_total) + (80000) }}</p>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="flex justify-between items-start w-full">
                                <div class="flex justify-center items-center space-x-4">
                                    ...
                                    <div class="flex flex-col justify-start items-center">
                                        <p class="text-lg leading-6 dark:text-white font-semibold text-gray-800">{{ getOrder.orders[0].delivery_type }}
                        ...
                        <div class="flex flex-col justify-start items-start flex-shrink-0">
                            ...
                            <div
                                ...
                                <img class="hidden dark:block"
                                    ...
                                    alt="email">
                                <p class="cursor-pointer text-sm leading-5 ">{{ getOrder.user.email }}</p>
                            </div>
                        </div>
